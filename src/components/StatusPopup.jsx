...
function StatusPopup(props) {
  ...
  return (
    <div class="modal fade" id={status==="confirm"?`confirm${id}`:`cancel${id}`} tabindex="-1">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div className="message-success">
              <span>
                Do you want to {status === "cancel"?"cancel":"confirm"} the booking for 
              ...
              <button
                type="button"
                class={status === "cancel"?"btn btn-danger d-flex":"btn btn-success"}
                data-bs-dismiss="modal"
